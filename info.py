...
API_ID = int(environ['24736263'])
API_HASH = environ['4d53732917b73a6bb89c3b2f2f7b0902']
BOT_TOKEN = environ['6294506492:AAHWWWbk1TmdFCvLDGcHRgPJrpyoHEDwoYU']
...
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS", "-1001862601820")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '1228255863 5257925921').split()]
...
my_users = [int(my_users) if id_pattern.search(my_users) else my_users for my_users in environ.get('MY_USERS', '1228255863 5257925921').split()]
